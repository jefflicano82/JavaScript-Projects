...
function get_todos() {
  ...
  /*If the input is not null then JSON.parse will communicate with the web brwser to make the task a JavaScript object.*/
  if (todos_str !== null) {
...
function show() {
  ...
  /*This tells the browser how to didsplay the todo array after an item has been removed*/
...
show();
/*this creates teh functionality of removing a todo item from teh array */
function remove() {
